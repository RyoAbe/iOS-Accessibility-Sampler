...
struct Documentation {
    ...
    static let top = Topic(
        ...
        sections: [
            .init(
                title: "Essentials",
                pages: [
                    .init(title: "UIAccessibility", type: .topic(topicUIAccessibility)),
                    .init(title: "UIAccessibilityContainer", type: .protocol),
                    .init(title: "Supporting VoiceOver in Your App", type: .protocol),
                ]
            ),
            .init(
                title: "Behaviors",
    ...
    static let topicUIAccessibility = Topic(
